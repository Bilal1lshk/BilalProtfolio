        ...
        <section id='Hireme' className='overflow-visible  px-0 py-14 text-slate-900 sm:py-16 lg:py-20'>
            <div className='mx-auto flex max-w-6xl flex-col px-4 sm:px-6 lg:px-8'>
                <div className='mx-auto max-w-3xl text-center'>
                    <motion.p initial={{ letterSpacing: '50px' }} viewport={{ once: true }} whileInView={{ letterSpacing: '2px' }} exit={{ letterSpacing: '2px' }} className='text-xs  tracking-[0.3em] text-g-primary sm:text-sm'>Contact</motion.p>
                ...
                <form onSubmit={handleSubmit} className='w-full rounded-[28px] border border-white/70 bg-white/90 p-5 pt-6 shadow-[0_30px_80px_rgba(15,23,42,0.08)] sm:p-8'>
                    ...
                    <button
                        type='submit'
                        className='mt-6 inline-flex w-full items-center justify-center rounded-2xl bg-g-primary px-5 py-3 text-sm font-semibold text-black transition hover:bg-g-deep'
                    >
                        Send message
                    </button>
