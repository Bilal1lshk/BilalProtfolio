    ...
    return (
        <div>
            ...
            " className='h-[700px] w-[900px] object-cover overflow-hidden' alt="" />
                ...
                <motion.h3 initial={{ opacity: 0.6, x: -100 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 1, ease: "easeOut" }} className='absolute top-1 text-xl text-g-primary '>
                ...
                <motion.div initial={{ opacity: 0.6, y: 100 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 1, ease: "easeOut" }} className='bg-g-deep text-gray-100   w-[460px] absolute top-[400px] left-[740px]'>
                    <h3 className='uppercase p-1.5'>
                        Making apps smarter with OpenAI, LangChain & custom-trained models.
                    </h3>
                </motion.div>
                <div className='absolute top-96 left-12 text-black '>
                    <div>
